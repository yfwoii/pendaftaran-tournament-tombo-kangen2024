document.querySelectorAll(".btnDetail").forEach((item) => {
  item.addEventListener("click", (e) => {
    ...
    let pesan = `https://api.whatsapp.com/send?phone=${nohp}&text=Halo, saya ingin mendaftarkan tim kami . mohon isi nama squad:...., no wa leader:...., username:...., Idleader:.... ${judul}. Gambar produk: ${gambar}.`;
